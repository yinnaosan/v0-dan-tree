      ...
      <div className="flex-1 overflow-y-auto">
        <div className="px-4 py-4 border-b border-white/[0.02]">
          ...
          <div className="space-y-3">
            <InsightItem type="confirm" title="台积电 CoWoS 扩产" detail="验证 H200 供应链" time="2h" />
            <InsightItem type="catalyst" title="微软 AI CapEx $50B+" detail="提升订单能见度" time="4h" />
          </div>
        </div>
        ...
        <div className="px-4 py-4 border-b border-white/[0.02]">
          ...
          <InsightItem type="watch" title="出口管制不确定性" detail="影响 ~15% 收入" time="1d" />
        </div>
